...
public class Node2Bean {
    ...
    /**
     * Gets the properties from the Node and sets the fields, translated if possible, of the object of the given class.
     *
     ...
     */
    public static <T> void addProperties(Node node, Collection<String> objectFieldNames, Class<T> clazz, String lang,
                                          Object object) throws RepositoryException, IllegalAccessException {
    ...
    /**
     * Gets the children nodes from the node and sets the their fields, translated if possible, of the object of the
     * given class.
     *
    ...
    public static <T> void addChildrenNodes(Node node, Collection<String> objectFieldNames, Class<T> clazz,
        ...
        while (nodes.hasNext()) {
            ...
            try {
                ...
                NodeUtils.forEach(children.getNodes(), item -> childrenNodes.add(toBean(item, class_, lang)));
