...
/**
 * This class is used to automatically detect the client's browser language when no language is
...
public class BrowserDetectedI18nContentSupport extends DefaultI18nContentSupport {
  ...
  /**
   * Determines the Locale using the URL (like http://example.com/en/) or with the Accept-Language
   * HTTP request
   * header.
   *
